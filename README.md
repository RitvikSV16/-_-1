Simple classification project using the standard dataset that is iris dataset. I have used the the sklearn.datasets library to directly load the iris dataset, so no need of downloading the dataset.
